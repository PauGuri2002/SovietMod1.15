...
//public class StaliniumDust extends Block {
//
...
//    public static final BooleanProperty POWER = BooleanProperty.create("powered");
...
//
//    public StaliniumDust() {
//        super(Block.Properties.from(Blocks.REDSTONE_WIRE));
//        this.setDefaultState(this.stateContainer.getBaseState().with(NORTH, RedstoneSide.NONE).with(EAST, RedstoneSide.NONE).with(SOUTH, RedstoneSide.NONE).with(WEST, RedstoneSide.NONE).with(POWER, false));
//
//    }
//
