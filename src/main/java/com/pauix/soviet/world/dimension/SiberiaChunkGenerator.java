...
public class SiberiaChunkGenerator extends NoiseChunkGenerator<SiberiaGenSettings> {
    ...
    public SiberiaChunkGenerator(IWorld worldIn, BiomeProvider provider, SiberiaGenSettings settingsIn) {
