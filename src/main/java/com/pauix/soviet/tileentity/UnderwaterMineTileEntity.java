...
public class UnderwaterMineTileEntity extends TileEntity implements ITickableTileEntity {

    private ITextComponent customName;
    private boolean isExploding = false;
    private int placeTimer = 100;

    public UnderwaterMineTileEntity(TileEntityType<?> tileEntityTypeIn) {
        super(tileEntityTypeIn);
    }

    public UnderwaterMineTileEntity() {
        this(ModTileEntityTypes.UNDERWATER_MINE.get());
    }
        ...
        if(this.world != null && !this.world.isRemote ) {
            if (this.placeTimer > 0) {
                ...
                if (!this.world.getEntitiesWithinAABB(PlayerEntity.class, t).isEmpty() || !this.world.getEntitiesWithinAABB(MonsterEntity.class, t).isEmpty()) {
                    ...
                    InstantTNTEntity tntentity = new InstantTNTEntity(this.world, (double) this.pos.getX() + 0.5D, this.pos.getY(), (double) this.pos.getZ() + 0.5D, null);
